...
namespace AWSSignatureV4_S3_Sample.Signers
{
    ...
    public abstract class AWS4SignerBase
    {
        ...
        public static HashAlgorithm CanonicalRequestHashAlgorithm = (HashAlgorithm)CryptoConfig.CreateFromName("SHA-256");
        ...
        {
            var kha = (KeyedHashAlgorithm)CryptoConfig.CreateFromName(algorithm);
            kha.Key = key;
